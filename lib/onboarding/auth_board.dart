                        ...
                        children: [
                          ...
                          Align(
                              ...
                              child: InkWell(
                                  ...
                                  child: Icon(Icons.arrow_back_outlined, color: Color(0xFF003049),))),
                          ...
                          Obx(() =>InkWell(
                            ...
                            child: Container(
                              ...
                              margin:  EdgeInsets.symmetric(horizontal: 43.sp),
                              decoration: BoxDecoration(
                                color: whiteColor,
                              ...
                              child: Center(
                                child: accountController.loadingStatus.value == true ? LoadingAnimationWidget.stretchedDots(color: Colors.white, size: 20)
                                  ...
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                      children: [
                                        Image.asset('assets/images/icons/Google.png', fit: BoxFit.scaleDown, scale: 22,),
                            ...
                            child: Container(
                              ...
                              child: Center(
                                child: accountController.loadingStatus.value == true ? LoadingAnimationWidget.stretchedDots(color: Colors.white, size: 20)
                                  ...
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  children: [
                                    Image.asset('assets/images/icons/Apple.png', fit: BoxFit.scaleDown, scale: 22,),
                            ...
                            child: Container(
                              ...
                              child: Center(
                                child: accountController.loadingStatus.value == true ? LoadingAnimationWidget.stretchedDots(color: Colors.white, size: 20)
                                  ...
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  children: [
                                    Image.asset('assets/images/icons/Email.png', fit: BoxFit.scaleDown, scale: 22,),
