  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        InkWell(
          onTap: (){
            isFavorite == true ?  musicController.removeFromFavourites(userController.getToken(),  favorite!['id']) : showDialog(
              context: context,
              builder: (context) => MusicDialog(favorite: favorite, favoriteList: favoriteList,),
            );
          },
            child: isFavorite == true ? IconSVG(assetPath: 'assets/images/icons/heart-filled.svg') : Icon(Icons.more_vert, color: whiteColor,),
        )
