...
const String userUrl ="$baseUrl/ppi/get_user_details?user_id=";

const String genreUrl ="$baseUrl/api/genre/list";
const String allSongsUrl ="$baseUrl/ppi/allmusic.php";


const String getPlaylistUrl ="$baseUrl/ppi/get_playlists?user_id=";
const String getPlaylistSongsUrl ="$baseUrl/ppi/get_playlist_by_id?playlist_id=";
