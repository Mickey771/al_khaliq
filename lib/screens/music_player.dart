...
class MusicPlayer extends StatefulWidget {
  ...
  MusicPlayer({super.key, this.index, this.isFavorite, required this.songs, this.songList});
...
class _MusicPlayerState extends State<MusicPlayer> {
  ...
  Future<void> _loadPlaylist() async {
    ...
    await audioHandler.loadAndPlay(widget.songList![widget.index!]); // play starting song
  }
          ...
          children: [
            ...
            Align(
                       ...
                       child: StreamBuilder<PlaybackState>(
                           ...
                           child: BackdropFilter(
                               ...
                               child: Container(
                                 ...
                                 decoration: BoxDecoration(
                                     color: Color(0xFF23232333).withOpacity(0.2),
                                     borderRadius: BorderRadius.circular(16.sp),
                                     border: Border.all(color: whiteColor.withOpacity(0.1), width: 1.sp)),
                                 child: Column(
                                       ...
                                       children: [
                                         Container(
                                           ...
                                           child: Container(
                                             ...
                                             child: IconSVG(
                                               assetPath: 'assets/images/icons/play.svg',
                                               color: Colors.white,
                                               height: 22.sp,
                                               width: 22.sp,
                                             ),
                                       ...
                                       children: [
                                         ...
                                         Row(
                                           children: [
                                             Obx(() => InkWell(
                                               onTap: () => shuffle(),
                                               child: IconSVG(
                                                 assetPath: 'assets/images/icons/shuffle.svg',
                                                 color: isShuffleEnabled.value == true ? lightBlueColor : whiteColor,
                                                 height: 22.sp,
                                                 width: 22.sp,
                                               ),
                                             ),),
                                             ...
                                             InkWell(
                                               ...
                                               child: IconSVG(
                                                 assetPath: 'assets/images/icons/previous.svg',
                                                 color: Colors.white,
                                                 height: 22.sp,
                                                 width: 22.sp,
                                               ),
                                             ...
                                             InkWell(
                                               ...
                                               child: isPlaying
                                                   ? IconSVG(
                                                 assetPath: 'assets/images/icons/stop.svg',
                                                 color: Colors.white,
                                                 height: 22.sp,
                                                 width: 22.sp,
                                               ) : IconSVG(
                                         ...
                                         StreamBuilder<Duration?>(
                                           ...
                                           builder: (context, snapshot) {
                                             ...
                                             return Text("${formatDuration(duration)}", style: TextStyle(
                                                 fontSize: 12.sp,
                                                 fontWeight: FontWeight.w400,
                                                 color: whiteColor));
                                           },
              ...
              Align(
                ...
                child: Padding(
                  padding: EdgeInsets.fromLTRB(20.sp, 20.sp, 20.sp, 00.sp),
                  child: Row(
                    ...
                    children: [
                     ...
                     Obx(() =>  InkWell(
                       onTap: (){
                         musicController.favouriteMusics.where((e) => e['id'] == widget.songs![currentIndex.value]['id']).isNotEmpty ?  musicController.removeFromFavourites(userController.getToken(), widget.songs![currentIndex.value]['id'])
                             : musicController.addFavourites(userController.getToken(), widget.songs![currentIndex.value]['id'], fromPage: true);
                       },
                       child: Container(
                               ...
                               child: BackdropFilter(
                                   ...
                                   child: Container(
                                     ...
                                     decoration: BoxDecoration(
                                         ...
                                         borderRadius: BorderRadius.circular(12.sp),
                                         border: Border.all(color: whiteColor.withOpacity(0.1), width: 1.sp)),
                                     child:  musicController.favouriteMusics.where((e) => e['id'] == widget.songs![currentIndex.value]['id']).isNotEmpty ? Row(
                                       children: [
                                         ...
                                         Icon(Icons.remove, color: whiteColor, size: 18,)
                                       ],
                                     ) : Row(
                                       children: [
                                         ...
                                         horizontalSpace(0.03),
                                         Icon(Icons.add, color: whiteColor, size: 18,)
                                       ],
                                     ),
                                   )
                               )
